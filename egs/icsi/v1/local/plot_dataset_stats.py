...
def main() -> int:
	parser = argparse.ArgumentParser(description="Plot and verify ICSI dataset stats (durations and overlaps)")
	parser.add_argument("--train-dir", default="data/icsi_train", help="Path to training data dir (Kaldi-style)")
	parser.add_argument("--eval-dir", default="data/icsi_eval", help="Path to evaluation/validation data dir (Kaldi-style)")
	parser.add_argument("--out-plot", default="data/icsi_dataset_durations.png", help="Output path for duration bar chart")
	...
	if HAS_MPL:
		...
		plt.title("ICSI dataset recording durations")
		# Annotate bars
